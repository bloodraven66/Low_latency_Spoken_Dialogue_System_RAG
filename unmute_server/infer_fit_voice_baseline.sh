...
# Warm up the endpointer GPU — the first CUDA kernel call takes 1-3s,
# which would cause item 001 to miss VAD detection timing on short utterances.
...
while IFS='|' read -r category json_type item_id audio_path; do
    ...
    python3.12 unmute/scripts/evaluate_recording.py \
