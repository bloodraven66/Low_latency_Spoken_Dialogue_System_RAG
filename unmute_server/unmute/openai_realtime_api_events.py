...
class UnmuteEndpointerProbability(BaseEvent[Literal["unmute.endpointer.probability"]]):
    """Endpointer turn-end probability at current time."""
    probability: float
    timestamp_sec: float
